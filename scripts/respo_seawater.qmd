...
```{r}
BioData <- read_csv(here("data","respofiles","Fragment_Measurements_RUN2.csv"))
RespoMeta <- read_csv(here("data","respofiles","Respo_meta_RUN2.csv"))
#View(BioData)
```
...
for(i in 1:length(filenames_final)) {
 ...
 #  Plot regression diagnostics
  ...
  for(j in 1:length(df$Light_level)){
   pdf(paste0(here("output","RUN2"),"/",rename,"_",j,".pdf" ))
    plot(df$regs[[j]])
    dev.off()
  }
  # pdf(paste0(here("output","RUN2"),"/",rename,".pdf"))
  # plot(regs)
  # dev.off() 
